...
class ModelHandler:
    def __init__(self, labels):
        ...
        register_synthetic_leaves()
        # self.cfg.merge_from_file("/opt/nuclio/Base-PhenorobPlants-PanopticSegmentation.yaml")
        self.cfg.merge_from_file("/opt/nuclio/mask2former_leaves.yaml")
        self.cfg.DATASETS.TRAIN = ('syn_train_leaves',)
        self.cfg.DATASETS.TEST = ('syn_train_leaves',)
        self.cfg.MODEL.DEVICE = 'cuda'
        self.cfg.MODEL.WEIGHTS = "/opt/nuclio/model_synthetic_leaves.pth"
